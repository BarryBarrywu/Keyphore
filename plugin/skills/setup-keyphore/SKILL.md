---
name: setup-keyphore
description: Install, validate, update, diagnose, or remove Keyphore for a NuPhy Air65 V3.
---

# Set up Keyphore

Resolve the plugin root as the directory two levels above this file. Use only the bundled `bin/keyphore` executable.
